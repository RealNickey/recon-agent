  ...
  "relative w-full rounded-lg border px-4 py-3 text-xs [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground [&>svg~*]:pl-7",
  {
    variants: {
      variant: {
        ...
        success:
          "border-emerald-500/40 text-emerald-400 [&>svg]:text-emerald-400 bg-emerald-500/5",
        warning:
          "border-amber-500/40 text-amber-400 [&>svg]:text-amber-400 bg-amber-500/5",
        info:
          "border-cyan-500/40 text-cyan-400 [&>svg]:text-cyan-400 bg-cyan-500/5",
      },
    },
    defaultVariants: {
      variant: "default",
